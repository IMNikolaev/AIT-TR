...
// Для создания связи типа HAS-A мы определяем поле класса,
    ...
    */
    ...
    public String toString() {
        ...
        String passengersList = createStringByPassengersList();
        stringBuilder.append("Autobus: {").append(" driver: ").append(driver.getLicenseNumber()).append("; autopilot: ").append(autopilot.getSoftwareVersion()).append(" }").append(passengersList);
